...
import '../styles/my_flutter_app_icons.dart';
...
class _PhraseListItemState extends State<PhraseListItem> {
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      background: backgroundGradient(Colors.blue, Colors.transparent),
      secondaryBackground: backgroundGradient(Colors.transparent, Colors.red),
      child: ListTile(
